...
```bash
sudo apt update && sudo apt -y dist-upgrade && rm -rf install.py && wget -qO install.py https://github.com/amidevous1/Xtream-Ui/raw/refs/heads/main/install.py && sudo python3 install.py
```
