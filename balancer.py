...
rDownloadURL = "https://github.com/amidevous1/Xtream-Ui/releases/download/download/sub_xui_masoudgb.zip"
...
def configure():
    ...
    subprocess.run("wget -q https://github.com/amidevous1/Xtream-Ui/releases/download/download/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb", shell=True, check=True)
    subprocess.run("wget -q https://github.com/amidevous1/Xtream-Ui/releases/download/download/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php", shell=True, check=True)
